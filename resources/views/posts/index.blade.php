...
@section('content')
        ...
        <div class="col-lg-8 mx-auto mt-5 pt-5 py-md-5">
            ...
            <main>
                ...
                <a class="btn btn-small btn-primary" href="{{ route('posts.create') }}">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td scope="row"><a href="{{ route('posts.edit', $value->id) }}">{{ $value->title }}</a><br/>Updated At: {{ $value->updated_at }} | Author: {{ $value->user->name }}</td>
                        <td>
                            <form action="{{ route('posts.destroy',$value->id) }}" method="POST">

                                <a href="{{ route('posts.edit', $value->id) }}" class="btn btn-small btn-secondary">
